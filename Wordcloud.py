...
default_excluded_words = {
    ...
    "lo", "desde", "hasta", "hacia", "usted", "tú", "yo", "compartir", "con", "para", "su", "nuestro",
    "o", "u", "e", "por", "eso", "foto", "fotos", "local", "reseñas", "más", "mas", "nos", "os", "ser", "estar", "sí", "si",
    "no", "ni", "guide", "hay", "se", "una", "uno"
}
